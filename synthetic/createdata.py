from synthetic.augmentation_letter import augmentate_letterdata
from synthetic.augmentation_retina import augmentate_retina
from synthetic.image_loader import imretina, imletnum
from synthetic.model_based_matrix import build_matrix, SensorMaskCartCircleArc
import numpy as np
import os

# ---------------------------------------------------------------------------
def create_trainatestdata(cache_dir):

    print('Obtaining data for training...')
    
    IM1 = imretina('synthetic/retina/')
    IM2 = imletnum('synthetic/letnum/')
